...
namespace Formula1.Core
{
    ...
    public class Controller : IController
    {
        ...
        public string AddCarToPilot(string pilotName, string carModel)
        {
            ...
            cars.Remove(crmodel);
            return $"Pilot { pilotName } will drive a {crmodel.GetType().Name} { carModel } car.";
        }
        ...
        public string AddPilotToRace(string raceName, string pilotFullName)
        {
            ...
            if (plfullname == null || !plfullname.CanRace || rcname.Pilots.Contains(plfullname))
            {
        ...
        public string StartRace(string raceName)
        {
            ...
            topDrivers[0].WinRace();
            string result=$"Pilot {topDrivers[0].FullName} wins the { raceName } race."+Environment.NewLine+
            $"Pilot {topDrivers[1].FullName} is second in the { raceName } race."+Environment.NewLine+
            $"Pilot {topDrivers[2].FullName} is third in the { raceName } race.";
            return result.Trim();
